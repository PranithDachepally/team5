...
<title>School Management System | Organization Info</title>
...
function edit() {
	...
	document.getElementById("email_server").readOnly = false;
	document.getElementById("email_server").style.border="1px inset #6060f1";
	
	document.getElementById("email_un").readOnly = false;
	document.getElementById("email_un").style.border="1px inset #6060f1";
	
	document.getElementById("email_pw").readOnly = false;
	document.getElementById("email_pw").style.border="1px inset #6060f1";
	
	document.getElementById("email_port").readOnly = false;
	document.getElementById("email_port").style.border="1px inset #6060f1";
...
<body>
<h2>School Management System | Organization Info</h2>
...
<div ng-app="orgApp" ng-controller="orgController"> 
	<form name="myform" method="post" onsubmit="return validateForm('Organization','false')">
...
%>	
		<tr><th colspan="2">Email Server Info</th></tr>
		<tr><td><b>Email Server</b></td><td><input size="50" id="email_server" class="orgform" type="text" name="email_server" value="{{ i.email_server }}" readonly /></td></tr>
		<tr><td><b>Email Username</b></td><td><input size="50" id="email_un" class="orgform" type="text" name="email_un" value="{{ i.email_un }}" readonly /></td></tr>
		<tr><td><b>Email Password</b></td><td><input size="50" id="email_pw" class="orgform" type="password" name="email_pw" value="{{ i.email_pw }}" readonly /></td></tr>
		<tr><td><b>Email Port</b></td><td><input size="50" id="email_port" class="orgform" type="text" name="email_port" value="{{ i.email_port }}" readonly /></td></tr>
	<%} %>	
